...
* **développer des méthodes de détection** d’individus, d'organisation ou de communautés d’intérêt à partir du graphe.
...
**Mission principale** : faciliter l'intégration des données et leur visualisation ; développer des outils pour les analystes :
